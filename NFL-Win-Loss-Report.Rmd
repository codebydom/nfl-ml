...
The offense and defense data is imported, then stripped of Takeaway and Turnover data in two different tables, then using an inner join function to pair the data correctly
